(function() {
  ...
  var CND, DRange, INTERLAP, InterLapLib, Interlap, LFT, MAIN, Multimix, PATH, Segment, alert, apply_drange, badge, cast, debug, declare, echo, freeze, help, hex, info, isa, log, rpr, type_of, urge, validate, warn, whisper;
