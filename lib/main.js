(function() {
  'use strict';
  var CND, DRange, Interlap, LFT, MAIN, PATH, Segment, alert, badge, cast, debug, declare, echo, freeze, help, hex, info, isa, log, rpr, type_of, urge, validate, warn, whisper;
  ...
  this.union = function(me, ...others) {
    var drange, i, j, k, len, len1, len2, other, segment;
